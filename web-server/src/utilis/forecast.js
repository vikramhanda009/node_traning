...
const forecast = (lat, long, callback) => {
    ...
    request({ url, json: true }, (error, { body }) => {
        ...
        if (error) {
            ...
            callback(undefined, 'today in ' + body.location.name + ' is' + body.current.weather_descriptions + " and wind speed is " + body.current.wind_speed + ' lat is ' + body.location.lat + ' and long ' + body.location.lon + '  humidity   ' + body.current.humidity + '%')
